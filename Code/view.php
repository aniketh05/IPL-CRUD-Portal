...
<html lang="en">
  ...
  <body>
    ...
    <h3 style="text-align:center; color: firebrick ">Squad Description</h3><hr>
...
<?php
  ...
  if(isset($_POST['submit1'])){ 
    ...
    { 
      ...
      {
        echo "<tbody><tr><td>" . $row["id"] . "</td><td>" . $row["fname"]. "</td><td>" . $row["lname"] . "</td><td>" . $row["Matches"] . "</td><td>" . $row["Runs"] . "</td><td>" . $row["HighestScore"] . "</td><td>" . $row["BatAverage"] . "</td><td>" . $row["StrikeRate"] . "</td><td>" . $row["Hundreds"] . "</td><td>" . $row["Fifties"] . "</td><td>" . $row["Fours"] . "</td><td>" . $row["Sixes"] . "</td><td>" . $row["Wickets"] . "</td><td>" . $row["BBM"] . "</td><td>" . $row["BowlAverage"] . "</td><td>" . $row["Econ"] . "</td></tr></tbody>";
      }
      echo "</table>";
    }
    else{
...
<h4 style="text-align:center; color: steelblue ">Squad Details filtered by ID</h4>
<form method="post">
  <div class="form-row">
...
<?php
  ...
  if(array_key_exists("id",$_POST)){ 
    ...
    //print_r ($_POST);
    $selectwhereQuery = "SELECT * FROM info WHERE id = ('$_POST[id]')"; 
    // echo $selectwhereQuery;
